...
const Darkmode: QuartzComponent = ({ displayClass, cfg, fileData }: QuartzComponentProps) => {
  const isEnglish = fileData.frontmatter?.lang === "en"
  const darkModeLabel = isEnglish
    ? "Switch to dark mode"
    : i18n(cfg.locale).components.themeToggle.darkMode
  const lightModeLabel = isEnglish
